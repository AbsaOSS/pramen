...
object PythonTransformationJob {
  val SYNCWATCHER_PY_CMD_LINE_TEMPLATE_KEY = "pramen.py.cmd.line.template"
  val SYNCWATCHER_PY_LOCATION_KEY = "pramen.py.location"
  val SYNCWATCHER_PY_EXECUTABLE_KEY = "pramen.py.executable"
