  ...
  "preRunCheckJob" should {
    "single day inputs" should {
      "track already ran" in {
        ...
        bk.setRecordCount("table1", infoDate, 4, 4, 123, 456, isTableTransient = false, overwrite = true)
      ...
      "track needs update" when {
        "some records, default minimum records" in {
          ...
          bk.setRecordCount("table1", infoDate, 100, 100, 123, 456, isTableTransient = false, overwrite = true)
    ...
    "ranged inputs" should {
      "already ran" in {
        ...
        bk.setRecordCount("table1", noDataInfoDate, 4, 4, 123, 456, isTableTransient = false, overwrite = true)
      ...
      "track needs update" in {
        ...
        bk.setRecordCount("table1", noDataInfoDate, 30, 30, 123, 456, isTableTransient = false, overwrite = true)
