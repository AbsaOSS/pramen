...
/**
  * This is a mock class that exists only for tests, but it is expected that the runtime classpath contains the real
  * implementation of this.
  */
class PramenNotificationBuilderFactory extends PramenNotificationBuilder {
  override def addEntries(entries: NotificationEntry*): Unit = ???
}
